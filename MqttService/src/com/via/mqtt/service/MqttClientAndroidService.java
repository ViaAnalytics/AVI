...
public class MqttClientAndroidService extends BroadcastReceiver implements
  ...
  private static final String SERVICE_NAME = "com.via.mqtt.service.MqttService";
  
  private static String TAG = "MqttClientAndroidService";
  ...
  private final class MyServiceConnection implements ServiceConnection {
    ...
    public void onServiceDisconnected(ComponentName name) {
      Log.d(TAG, "Disconnecting MqttService");
      mqttService = null;
      clientHandle = null;
    }
  }
  ...
  public IMqttToken connect(MqttConnectOptions options, Object userContext,
    ...
    if (mqttService == null) { // First time - must bind to the service
      Log.d(TAG, "mqttService null: creating and binding service");
      Intent serviceStartIntent = new Intent();
      serviceStartIntent.setClassName(myContext, SERVICE_NAME);
      Log.d(TAG,"serviceStartIntent: " + serviceStartIntent.toString());
...
//      Log.d(TAG,MqttServiceConstants.CALLBACK_TO_ACTIVITY);
...
//      Log.d(TAG,"filter: " + filter.toString());
      ...
      pool.execute(new Runnable() {
        ...
        @Override
        public void run() {
          Log.d(TAG, "starting doConnect() from runnable");
          doConnect();
  ...
  private void doConnect() {
    Log.d(TAG, "in doConnect()");
    if (mqttService != null) {
      if (clientHandle == null) {
        Log.d(TAG, "clientHandle is null; getting client");
      ...
      IMqttActionListener listener = connectToken.getActionCallback();
      if (listener != null) {
        Exception e = new Exception("mqttService set to null -- thread competition?");
        listener.onFailure(connectToken, e);
      }
    }
  }
  ...
  public IMqttDeliveryToken publish(String topic, byte[] payload, int qos,
    ...
    try {
    	internalToken = mqttService.publish(clientHandle,
  ...
  public IMqttToken subscribe(String topic, int qos, Object userContext,
    ...
    String activityToken = storeToken(token);
//    Log.d("subscribe",activityToken);
//    Log.d("subscribe",mqttService.toString());
      ...
      if (callback != null) {
        ...
        if (status == Status.OK) {
        	try {
        		...
        		Log.e(TAG, "Error processing notification of delivered message", e);
        	}
        }
      }
    }
  ...
  public void disconnectForcibly() throws MqttException {
    mqttService.disconnectForcibly(clientHandle);
  }
  ...
  public void disconnectForcibly(long disconnectTimeout) throws MqttException {
    mqttService.disconnectForcibly(clientHandle, disconnectTimeout);
  }

  @Override
  public void disconnectForcibly(long quiesceTimeout, long disconnectTimeout)
      throws MqttException {
    mqttService.disconnectForcibly(clientHandle, disconnectTimeout, quiesceTimeout);
  }
}
